...
function enviar($para){
  ...
  $mail->IsHTML(true);
  $mail->Username = 'app.code.guanajuato@gmail.com';
  $mail->Password = 'menta11.';
  $mail->FromName = 'CODE Guanajuato';
  $mail->AddReplyTo('sistemas.code@guanajuato.gob.mx','CODE Guanajuato');
  $mail->CharSet = 'UTF-8';
  $mail->Subject = 'Gracias por Instalar la Aplicación de CODE Guanajuato';
  $mail->Body = '
...
<th style="color: #0a0a0a; font-family: Helvetica,Arial,sans-serif; font-weight: normal; text-align: left; line-height: 19px; font-size: 16px; margin: 0; padding: 0;" align="left">
  <h1 style="color: inherit; font-family: Helvetica,Arial,sans-serif; font-weight: normal; text-align: left; line-height: 1.3; word-wrap: normal; font-size: 34px; margin: 0 0 10px; padding: 0;" align="left">¡Hola, <b>'.$para.'</b>!</h1>
  <p class="lead" style="color: #0a0a0a; font-family: Helvetica,Arial,sans-serif; font-weight: normal; text-align: left; line-height: 1.6; font-size: 20px; margin: 0 0 10px; padding: 0;" align="left">
  
     <b>!Bienvenido¡</b> a la aplicación móvil de la Comisión de Deporte del Estado de Guanajuato. 
  </p>
  <p style="color: #0a0a0a; font-family: Helvetica,Arial,sans-serif; font-weight: normal; text-align: left; line-height: 19px; font-size: 16px; margin: 0 0 10px; padding: 0;" align="left">Te invitamos a que descargues el manual que hemos adjuntado para tí.</p>
...
<th style="color: #0a0a0a; font-family: Helvetica,Arial,sans-serif; font-weight: normal; text-align: left; line-height: 19px; font-size: 16px; margin: 0; padding: 0;" align="left">
  ...
  $mail->addAttachment("../../res/mail/Binder.pdf","ManualAppCODE.pdf");
