...
function renderizarEventos(){
  ...
  for (var i = 0 ; i < eventos.length; i++){
    ...
    "<td>"+fInicio+"</td>" +
    "<td>"+fFin+"</td>" +
    "<input type='hidden' value='"+eventos[i].hombre+"'>" +
    "<input type='hidden' value='"+eventos[i].mujer+"'>" +
  ...
  $(".edit").on('click', function(){
    ...
    $('#modal1').openModal();
    $($("#texto").val($($(this).parent().children()[2]).html()).siblings()[0]).addClass("active");
    $($("#descripcion").val($($(this).parent().children()[3]).html()).siblings()[0]).addClass("active");
    $($("#liga").val($($(this).parent().children()[3]).html()).siblings()[0]).addClass("active");

    var f1 = $($(this).parent().children()[4]).html();
    $("#fecha_lan").val(moment(f1,"DD/MM/YYYY [a las] HH:mm").format("DD/MM/YYYY"));
    $($("#fecha_lan").siblings("label")[0]).addClass("active");
