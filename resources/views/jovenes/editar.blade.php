...
@section('head')
    <script type="text/javascript" src="{{url('/js/joven/crear.js')}}"></script>
@endsection
...
@section('contenedor')
    ...
    <div class="row">
        ...
        @endforeach
        <form id="form-nj" method="post" action="{{url('/jovenes/editar')}}" class="col s12" enctype="multipart/form-data">
