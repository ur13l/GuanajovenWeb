        ...
        <table class="highlight">
            <thead>
                <tr>
                    ...
                    <th class="header" data-field="funcionario.telefono" style="width: 100px; cursor: pointer">Teléfono</th>
                    <th class="header" data-field="rol.nombre_vista"style="width: 100px; cursor: pointer">Rol</th>
                    <th class="header" data-field="puesto.nombre" style="width: 100px; cursor: pointer">Puesto</th>
            ...
            <tbody id="tabla-usuarios">
                    @foreach($usuarios as $user)
                            ...
                            <td style="width: 100px">{{$user->puesto()->nombre_vista}}</td>
